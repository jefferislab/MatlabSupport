...
mex nrrdLoad.c -I/usr/local64/include -L/usr/local64/lib/ -lteem -lz -lm
mex nrrdLoadOrientation.c -I/usr/local64/include -L/usr/local64/lib/ -lteem -lz -lm
mex nrrdSave.c -I/usr/local64/include -L/usr/local64/lib/ -lteem -lz -lm
